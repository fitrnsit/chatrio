...
socket.on("history", function(data) {
  ...
  socket.on("chat", function(msTime, person, msg) {
    console.log(msg);
	var translateURL = "https://www.googleapis.com/language/translate/v2?key=AIzaSyCjWzv71A-rohf5ldmmNakD0J7xPlDhT8U&target=" + language_client  +"&q=" + msg;
		...
		if(this.readyState === 4){
			...
			req2.onreadystatechange = function(){
				if(req2.readyState === 4){
					...
					msg2 = escape(msg2);
					var emotionURL_1 = "https://api.havenondemand.com/1/api/async/analyzesentiment/v1?text=" + msg2 + "&language=eng&apikey=" + "28ab51e3-5d54-446d-ae55-fe0ee836f65b"
					...
					re3.onreadystatechange = function(){
						if(re3.readyState===4){
							...
							var emotionURL_2 = "https://api.havenondemand.com/1/job/result/" + jobId + "?apikey=" + "28ab51e3-5d54-446d-ae55-fe0ee836f65b";
