...
socket.on("history", function(data) {
  ...
  socket.on("chat", function(msTime, person, msg) {
    console.log(msg);
	var translateURL = "https://www.googleapis.com/language/translate/v2?key=KEY&target=" + language_client  +"&q=" + msg;
	...
	req.onreadystatechange = function(){
		if(this.readyState === 4){
			...
			console.log(newMsg);
			var translateURL2 = "https://www.googleapis.com/language/translate/v2?key=KEY&target=en&q=" + msg;
			...
			req2.onreadystatechange = function(){
				if(req2.readyState === 4){
					...
					msg2 = escape(msg2);
					var emotionURL_1 = "https://api.havenondemand.com/1/api/async/analyzesentiment/v1?text=" + msg2 + "&language=eng&apikey=" + "KEY"
					...
					re3.onreadystatechange = function(){
						if(re3.readyState===4){
							...
							var emotionURL_2 = "https://api.havenondemand.com/1/job/result/" + jobId + "?apikey=" + "KEY";
